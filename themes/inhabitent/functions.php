...
function red_starter_scripts() {
	wp_enqueue_style( 'red_starter-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'inhabitent-search-bar', get_template_directory_uri() .
		'/build/js/search-bar.min.js', array('jquery'), false, true);
